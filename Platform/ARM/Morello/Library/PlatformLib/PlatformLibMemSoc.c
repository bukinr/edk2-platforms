  ...
  )
{
  ...
  STATIC_ASSERT (
    FixedPcdGet64 (PcdHdmiI2cBusCadanceControllerIoBase) != 0
                &&  FixedPcdGet64 (PcdHdmiI2cBusCadanceControllerIoBase) >= MORELLO_EXP_PERIPH_BASE
                && (FixedPcdGet64 (PcdHdmiI2cBusCadanceControllerIoBase) + FixedPcdGet64 (PcdHdmiI2cBusCadanceControllerIoSize) < MORELLO_EXP_PERIPH_BASE + MORELLO_EXP_PERIPH_SZ),
